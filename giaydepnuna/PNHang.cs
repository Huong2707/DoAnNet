...
namespace giaydepnuna
{
    public partial class PNHang : Form
    {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            string sql;
            sql = string.Format(" SELECT CTPHIEUNHAPKHO.IDSP , GIAYDEP.TENSP,CTPHIEUNHAPKHO.SOLUONG, GIAYDEP.GIA FROM CTPHIEUNHAPKHO , GIAYDEP WHERE CTPHIEUNHAPKHO.IDPNK = N'{0}' AND CTPHIEUNHAPKHO.IDSP = GIAYDEP.IDSP", txtpn.Text);
            CTPHIEUNHAPKHO = kn.laydulieu(sql);
            dgvctphieunhap.DataSource = CTPHIEUNHAPKHO;
