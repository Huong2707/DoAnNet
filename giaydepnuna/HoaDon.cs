...
namespace giaydepnuna
{
    public partial class HoaDon : Form
    {
        ...
        public void LoadDGV()
        {
            string sql = string.Format(" SELECT CTHOADON.IDSP , GIAYDEP.TENSP,CTHOADON.SoLuong, GIAYDEP.GIA FROM CTHOADON, GIAYDEP WHERE CTHOADON.IDHD = N'{0}' AND CTHOADON.IDSP = GIAYDEP.IDSP ", idhd.Text);
        ...
        private void btnTimkiemHD_Click(object sender, EventArgs e)
        {
            ...
            string sql;
            sql = string.Format(" SELECT CTHOADON.IDSP , GIAYDEP.TENSP,CTHOADON.SoLuong, GIAYDEP.GIA FROM CTHOADON, GIAYDEP WHERE CTHOADON.IDHD = N'{0}' AND CTHOADON.IDSP = GIAYDEP.IDSP ", cbBoxMaHD.Text);
            CTHOADON = kn.laydulieu(sql);
            dgvThongtinSP.DataSource = CTHOADON;
